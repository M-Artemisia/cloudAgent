...
def _get_resource_id(self, resource_type, resource_name, username=None, password=None,tenant=None):
	...
	tenant_id = tenant_id['message']   
        ...
        return {"status":"error" , "message" : "Resource "+resource_type+ " is not supported"}
    ...
    if not resource_id :
        ...
        return {"status":"error" , "message" : "Resource "+resource_type+ " with the name "+resource_name+ " was not found on openstack"}
